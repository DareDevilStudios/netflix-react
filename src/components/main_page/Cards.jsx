...
const Cards = () => {
    return (
        <>
            <div className="text-white bg-black w-full flex p-20 justify-center items-center">
                <div className="left w-1/2">
                    <h1 className="text-5xl font-black text-center">Enjoy on your TV</h1>
            ...
            <hr/>
            <div className="text-white bg-black w-full flex flex-row-reverse p-20 justify-center items-center">
                <div className="left w-1/2">
                    <h1 className="text-5xl font-black text-center">Enjoy on your TV</h1>
                    <h1 className="text-xl my-5 font-semibold text-center">Watch on smart TVs, PlayStation, Xbox,
                        Chromecast, Apple TV, Blu-ray players and more.</h1>
